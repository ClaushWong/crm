...
const Menus = () => {
  ...
  const toMenu = (menu: IMenu, inheritId: string = "") => {
    ...
    if (menu.children && menu.children.length > 0) {
      return (
        <Menu.SubMenu title={menu.name} key={`sub-${key}`} icon={menu.icon}>
      ...
      <Row justify="space-between" align="middle">
        ...
        <Col>
          <Dropdown
            ...
            arrow
          >
            <Typography.Text style={{ userSelect: "none", cursor: "pointer" }}>
  ...
  return (
    <Layout>
      ...
      <Layout>
        ...
        <Layout>
          <Layout.Content
            style={{ padding: "24px 24px 0 24px", margin: 0, minHeight: 280 }}
          >
            ...
            >
              <Col>
                <Typography.Text>
                  <CopyrightOutlined />
                  &nbsp;
                  {new Date().getFullYear()}&nbsp;Claush&nbsp; All rights
                  reserved.
                </Typography.Text>
              </Col>
              <Col>
